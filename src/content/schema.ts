  ...
  help: fields.object(
    {
      ...
      investorImage: image("Inwestor — zdjęcie karty (530×275)", "investments"),
      investorTitle: fields.text({ label: "Inwestor — tytuł karty" }),
      investorText: fields.text({ label: "Inwestor — tekst karty obok formularza", multiline: true }),
      designerImage: image("Projektant — zdjęcie karty (530×275)", "investments"),
      designerTitle: fields.text({ label: "Projektant — tytuł karty (np. Pomożemy przy projekcie)" }),
      designerText: fields.text({ label: "Projektant — tekst karty obok formularza", multiline: true }),
      formTitle: fields.text({ label: "Inwestor — tytuł formularza (np. Wypełnij formularz)" }),
      designerFormTitle: fields.text({ label: "Projektant — tytuł formularza (np. Wypełnij formularz)" }),
      phone: fields.text({ label: "Pole: telefon" }),
      email: fields.text({ label: "Pole: e-mail" }),
    ...
    { label: "Oferujemy pomoc przy projekcie (karta + formularz)" },
  ),
        ...
        fields.object({
          ...
          items: fields.array(
            fields.object({
              ...
              title: fields.text({ label: "Tytuł" }),
              text: fields.text({ label: "Okno po kliknięciu + — opis", multiline: true }),
              cover: image("Okno — zdjęcie u góry (1080×300, puste = zdjęcie karty)", "investments"),
              details: fields.array(
                fields.object({
                  image: image("Zdjęcie (530×298)", "investments"),
                  title: fields.text({ label: "Tytuł" }),
                  text: fields.text({ label: "Tekst", multiline: true }),
                }),
                { label: "Okno — bloki zdjęcie + tekst", itemLabel: (d) => d.fields.title.value || "Blok" },
              ),
            }),
