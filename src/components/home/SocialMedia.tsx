...
// (Figma had squares, which cut off the top and bottom of Instagram's 4:5 posts).
      ...
      >
        {posts.map((p, i) => (
          <a
            ...
            className="relative block h-[281px] w-[225px] shrink-0 overflow-hidden rounded-[16px] shadow-dark-l"
          >
