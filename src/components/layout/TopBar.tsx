...
// mega menu (content: panel → Mega menu).
export function TopBar({ settings, menu, lang }: { settings: SettingsContent; menu: MenuContent; lang: Locale }) {
  ...
  return (
    <StickyHeader menu={menu} closeLabel={ui.close}>
      <div className="flex h-[60px] w-full items-center gap-[30px] overflow-clip rounded-[8px] bg-white pr-[15px] transition-shadow duration-300 group-data-[stuck]/header:shadow-[0_10px_30px_rgba(0,0,0,0.15)]">
